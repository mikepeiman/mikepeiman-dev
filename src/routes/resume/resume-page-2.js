const resume_items = [
    ...
    },
    {
        ...
        description: {
            ...
            brief: 'Based on an Egghead.io tutorial using React which I implemented in SvelteKit.',
            full: ''
        },
        achievements: [
            { name: 'Followed a React tutorial but implemented in SvelteKit', description: '', url: '' },
            { name: 'Worked ahead and added features beyond tutorial, eg. use of localStorage', description: '', url: '' },
            { name: 'Learned a process for replicating UIs with pixel-perfect detail', description: '', url: '' },
        ],
        technologies_used: ['Sveltekit', 'TailwindCSS', 'localStorage'],
        skills_applied: [],
        date_begun: '',
        date_completed: '',
        date_single: 'Jan 2022',
